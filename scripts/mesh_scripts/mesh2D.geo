...
Physical Line("Inlet") = {4};             // Left edge
Physical Line("Outlet") = {2};            // Right edge
Physical Line("Walls") = {1,3};           // Top and bottom edges
Physical Line("Cylinder") = {5,6,7,8};    // Cylinder boundary
Physical Surface("Fluid") = {1};          // Fluid domain
